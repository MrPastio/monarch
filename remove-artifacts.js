...
content = content.replace(/\s*await assertArtifactsModuleWritesSafely\(\);/g, '');

const func1 = 'async function assertArtifactsModuleWritesSafely(): Promise<void> {';
...
console.log('Artifacts test removed successfully!');
